...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationService.LocationRequestListener {
    ...
    public void onLocationRequest() {
        ...
        ((MensaDresdenApplication) getApplication()).setHasReceivedLocationPermissionPrompt(false);
        ((MensaDresdenApplication) getApplication()).setHasReceivedLocationEnablePrompt(false);
    ...
    private void checkPermissionAndRequestLocationUpdates() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if (((MensaDresdenApplication) getApplication()).hasReceivedLocationPermissionPrompt()) {
            ...
            ((MensaDresdenApplication) getApplication()).setHasReceivedLocationPermissionPrompt(true);
            ...
            public void onResult(LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        if (((MensaDresdenApplication) getApplication()).hasReceivedLocationEnablePrompt()) {
                            // if the activity has been re-created after a configuration change, we don't prompt the user again. We don't wanna be annoying.
                            return;
                        }
                        ((MensaDresdenApplication) getApplication()).setHasReceivedLocationEnablePrompt(true);
                        try {
